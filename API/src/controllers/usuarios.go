...
// AtualizarUsuarios altera as informações de um usuário no banco
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioIDNoToken != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("nao é possivel atualzar a senha de um usuario que nao seja o seu"))
		return
	}
